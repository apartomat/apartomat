...
export type ProjectFilesTotalResult = Forbidden | ProjectFilesTotal;
...
export const ProjectScreenProjectFragmentDoc = gql`
  ...
  files {
    ...
    total(filter: {type: [VISUALIZATION]}) {
      __typename

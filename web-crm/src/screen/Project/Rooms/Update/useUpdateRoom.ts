...
import { useUpdateRoomMutation, UpdateRoomMutation, UpdateRoomInput, UpdateRoomMutationResult } from "api/types.d"
...
export type { ProjectScreenHouseRoomFragment } from "api/types.d"
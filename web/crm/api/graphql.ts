...
export type AddSplitCoverToAlbumInput = {
  ...
  imgFileId: Scalars['String'];
  subtitle?: InputMaybe<Scalars['String']>;
  title: Scalars['String'];
  withQr?: InputMaybe<Scalars['Boolean']>;
...
export type AlbumPage = {
  ...
  /** @deprecated Render page on frontend instead. */
...
export type Cover = CoverUploaded | SplitCover;

export type CoverFileResult = File | Forbidden | NotFound | ServerError;

export type CoverUploaded = {
  __typename?: 'CoverUploaded';
  file: CoverFileResult;
};
...
export type Mutation = {
  ...
  addSplitCoverToAlbum: AddSplitCoverToAlbumResult;
...
export type MutationAddSplitCoverToAlbumArgs = {
...
export type ProjectPageResult = NotFound | ProjectPage | ServerError;

export type ProjectPageSettings = {
  __typename?: 'ProjectPageSettings';
...
export type SplitCover = {
  __typename?: 'SplitCover';
  city?: Maybe<Scalars['String']>;
  image: SplitCoverImageFileResult;
  qrCodeSrc?: Maybe<Scalars['String']>;
...
export type SplitCoverAdded = {
  __typename?: 'SplitCoverAdded';
  cover: SplitCover;
};
...
export enum SplitCoverVariant {
  ImageOnTheLeft = 'IMAGE_ON_THE_LEFT',
  ImageOnTheRight = 'IMAGE_ON_THE_RIGHT'
}
...
export type GenerateAlbumFileMutation = { __typename?: 'Mutation', generateAlbumFile: { __typename: 'AlbumFileGenerationStarted', file: { __typename?: 'AlbumFile', id: string, status: AlbumFileStatus, version: number, generatingStartedAt?: any | null, generatingDoneAt?: any | null, file?: { __typename?: 'File', url: any, type: FileType, mimeType: string, size: number } | null } } | { __typename: 'Forbidden', message: string } | { __typename: 'NotFound', message: string } | { __typename: 'ServerError', message: string } };
...
export type OnAlbumFileGeneratedSubscription = { __typename?: 'Subscription', albumFileGenerated: { __typename: 'AlbumFile', id: string, status: AlbumFileStatus, version: number, generatingStartedAt?: any | null, generatingDoneAt?: any | null, file?: { __typename?: 'File', url: any, type: FileType, mimeType: string, size: number } | null } | { __typename: 'Forbidden', message: string } | { __typename: 'NotFound', message: string } | { __typename: 'ServerError', message: string } | { __typename: 'Unknown', message: string } };
...
export type AlbumScreenAlbumPageCoverFragment = { __typename?: 'AlbumPageCover', id: string, number: number, rotate: number, svg: { __typename?: 'NotFound', message: string } | { __typename?: 'ServerError', message: string } | { __typename?: 'Svg', svg: string }, cover: { __typename?: 'CoverUploaded', file: { __typename?: 'File', url: any } | { __typename?: 'Forbidden', message: string } | { __typename?: 'NotFound', message: string } | { __typename?: 'ServerError', message: string } } | { __typename?: 'SplitCover', title: string, subtitle?: string | null, qrCodeSrc?: string | null, city?: string | null, year?: number | null, variant: SplitCoverVariant, image: { __typename?: 'File', id: string, url: any } | { __typename?: 'NotFound', message: string } | { __typename?: 'ServerError', message: string } } };

export type AlbumScreenAlbumPageVisualizationFragment = { __typename?: 'AlbumPageVisualization', id: string, number: number, rotate: number, svg: { __typename?: 'NotFound', message: string } | { __typename?: 'ServerError', message: string } | { __typename?: 'Svg', svg: string }, visualization: { __typename?: 'NotFound', message: string } | { __typename?: 'ServerError', message: string } | { __typename?: 'Visualization', id: string, file: { __typename?: 'File', url: any } } };

export type AlbumScreenFileFragment = { __typename?: 'AlbumFile', id: string, status: AlbumFileStatus, version: number, generatingStartedAt?: any | null, generatingDoneAt?: any | null, file?: { __typename?: 'File', url: any, type: FileType, mimeType: string, size: number } | null };
...
export type CreateAlbumMutation = { __typename?: 'Mutation', createAlbum: { __typename: 'AlbumCreated', album: { __typename?: 'Album', id: string, name: string, cover: { __typename?: 'File', url: any } | { __typename?: 'Forbidden', message: string } | { __typename?: 'NotFound', message: string } | { __typename?: 'ServerError', message: string } } } | { __typename: 'Forbidden', message: string } | { __typename: 'ServerError', message: string } };
...
export type MakeProjectNotPublicMutation = { __typename?: 'Mutation', makeProjectNotPublic: { __typename: 'Forbidden', message: string } | { __typename: 'NotFound', message: string } | { __typename: 'ProjectIsAlreadyNotPublic' } | { __typename: 'ProjectMadeNotPublic', projectPage: { __typename?: 'ProjectPage', status: ProjectPageStatus } } | { __typename: 'ServerError', message: string } };
...
export type ProjectScreenAlbumFragment = { __typename?: 'Album', id: string, name: string, cover: { __typename?: 'File', url: any } | { __typename?: 'Forbidden', message: string } | { __typename?: 'NotFound', message: string } | { __typename?: 'ServerError', message: string } };

type ProjectScreenProjectPage_NotFound_Fragment = { __typename: 'NotFound' };

type ProjectScreenProjectPage_ProjectPage_Fragment = { __typename: 'ProjectPage', id: string, status: ProjectPageStatus, url: string, settings: { __typename?: 'ProjectPageSettings', visualizations: boolean, albums: boolean } };

type ProjectScreenProjectPage_ServerError_Fragment = { __typename: 'ServerError' };

export type ProjectScreenProjectPageFragment = ProjectScreenProjectPage_NotFound_Fragment | ProjectScreenProjectPage_ProjectPage_Fragment | ProjectScreenProjectPage_ServerError_Fragment;
...
export type WorkspaceScreenUsersFragment = { __typename?: 'WorkspaceUsers', list: { __typename?: 'Forbidden', message: string } | { __typename?: 'ServerError', message: string } | { __typename?: 'WorkspaceUsersList', items: Array<{ __typename?: 'WorkspaceUser', id: string, role: WorkspaceUserRole, profile: { __typename?: 'UserProfile', id: string, email: string, fullName: string, abbr: string, gravatar?: { __typename?: 'Gravatar', url: string } | null } }> } };

export type WorkspaceScreenUserFragment = { __typename?: 'WorkspaceUser', id: string, role: WorkspaceUserRole, profile: { __typename?: 'UserProfile', id: string, email: string, fullName: string, abbr: string, gravatar?: { __typename?: 'Gravatar', url: string } | null } };
...
export const ProjectScreenProjectPageFragmentDoc = gql`
...
${ProjectScreenProjectPageFragmentDoc}`;

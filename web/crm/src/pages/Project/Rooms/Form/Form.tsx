...
export default function Room({
    ...
    return (
        ...
        >
            <FormField name="name" label="Название" width="medium" onChange={handleChangeName}>
                <TextInput name="name" suggestions={suggestions} placeholder="Комната" />
            </FormField>
            <FormField name="square" label="Площадь,&nbsp;м²" width="xsmall">
                <MaskedInput name="square" mask={[{ regexp: /^[\d*,\d*]+$/, placeholder: "0,0" }]} width="xsmall" />
            </FormField>
            {submit}
        </Form>
    )

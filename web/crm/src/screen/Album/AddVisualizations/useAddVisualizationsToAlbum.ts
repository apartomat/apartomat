...
import {
    useAddVisualizationsToAlbumMutation,
    AddVisualizationsToAlbumMutation,
    AddVisualizationsToAlbumMutationResult,
} from "api/graphql"

export function useAddVisualizationsToAlbum(
    albumId: string
): [
    ...
    return [(visualizations: string[]) => add({ variables: { albumId, visualizations } }), result]
}
